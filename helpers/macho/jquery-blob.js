...
! function(e) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = e();
        ...
        var t;
        t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, t.blobUtil = e()
    }
}(function() {
    return function e(t, n, r) {
        ...
        1: [function(e, t, n) {
            ...
            function b(e, t, n) {
                return j.resolve().then(function() {
                    return "function" == typeof e.toBlob ? new j(function(r) {
                        e.toBlob(r, t, n)
                    }) : p(e.toDataURL(t, n))
                })
            }
...
export function save_to_file(fileName) {

    let blob = window.tempFile; //Get the current blob
    if (!blob) {
        alert('No file yet.');
        return undefined;
    }
